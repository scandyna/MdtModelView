...
class MdtItemModelConan(ConanFile):
  name = "mdtitemmodel"
  ...
  def requirements(self):
    ...
    self.requires("mdtnumeric/0.0.9@scandyna/testing", transitive_headers=True, transitive_libs=True)
  ...
  def generate(self):
    ...
    tc.variables["BUILD_ITEM_MODEL"] = "ON"
