...
class MdtItemViewQtWidgetsConan(ConanFile):
  name = "mdtitemviewqtwidgets"
  ...
  def export_sources(self):
    ...
    copy(self, "libs/ItemView_QtWidgets/*", source_root, self.export_sources_folder)
  ...
  def generate(self):
    ...
    tc.variables["BUILD_ITEM_VIEW_QT_WIDGETS"] = "ON"
    tc.variables["BUILD_ITEM_MODEL_TEST_LIB"] = "OFF"
    tc.generate()
  ...
  def package_info(self):
    self.cpp_info.set_property("cmake_file_name", "Mdt0ItemViewQtWidgets")
